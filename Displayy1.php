...
$conn = mysqli_connect("localhost", "root", "", "product1");
  ...
  $result = $conn->query($sql1);
	   ...
	   echo '<h4 style="text-align:center;">Panasonic</h4>'; 
	echo '<p style="text-align:center;"><img border="0" alt="panasonic" src="soundbox/p-sound.jpg" width="200" height="250" ></p>';
  echo '<p style="text-align:center;" href= "compare.php" class= "btn btn-lg  btn-warning">Compare</p>';
   $sql1 = "SELECT * FROM product_info where id=".$_GET["data"];
  $result = $conn->query($sql1);
  }
	   ...
	   echo '<h4 style="text-align:center;">Samsung</h4>'; 
	echo '<p style="text-align:center;"><img border="0" alt="Samsung" src="soundbox/samsung.jpg" width="200" height="250" ></p>';
  echo '<p style="text-align:center;" href= "compare.php" class= "btn btn-lg  btn-warning">Compare</p>';
   $sql1 = "SELECT * FROM product_info where id=".$_GET["data"];
  $result = $conn->query($sql1);
  }
...
<!------confirm order----->    
 <div>
     <span>
       <a style="text-align:right;" href="order.php" class= "btn btn-lg  btn-success">Order</a>
     </span> 
    </div>   
